...
config :phoenix_live_view_demo, PhoenixLiveViewDemo.Repo,
  username: "postgres",
  password: "postgres",
  database: "phoenix_live_view_demo_dev",
  hostname: "localhost",
...
config :phoenix_live_view_demo, PhoenixLiveViewDemoWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/phoenix_live_view_demo_web/{live,views}/.*(ex)$",
      ~r"lib/phoenix_live_view_demo_web/templates/.*(eex)$",
      ~r{lib/phoenix_live_view_demo_web/live/.*(ex)$}
    ]
  ]
